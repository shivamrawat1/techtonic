...
# Initialize the OpenAI client with behavioral-specific prompt
...
@ensure_csrf_cookie
def index(request):
    return render(request, 'interview_behavioral/index.html')
...
# Removed 'save_assessment_behavioral' and 'list_behavioral_interviews' views
